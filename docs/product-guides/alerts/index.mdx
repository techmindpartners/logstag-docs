---
title: Alerts
description: How Logstag alerts work — templates, policies, severity, and operational workflow.
---
...
Metric definitions for the organization Alerts page and alert group detail live in the
